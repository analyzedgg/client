...
angular.module('leagueApp.statistics.bestTeam')
    .service('BestTeamService', bestTeamService);

function bestTeamService() {
    return {
        getSeriesData: function (matchDetails) {
            ...
            var seriesData = calculateSeriesData(sortedMatchesByTeamWithMatch);
    ...
    function calculateSeriesData(sortedMatchesByTeam) {
        var initialData = {
